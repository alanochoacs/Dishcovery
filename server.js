...
// MySQL connection config (adjust as needed for your own computer)
const dbConfig = {
    host: 'localhost',
    user: 'root',
    password: 'root',
...
app.get('/api/search', async (req, res) => {
    ...
    try {
        const connection = await mysql.createConnection(dbConfig); // Setup connection to frontend
        ...
        await connection.end(); // Close connection to frontend
